...
class ECSAuthToken {
    ...
    public function validate($ecs_hash, $ecs_login, $ecs_firstname, $ecs_lastname, $ecs_email, $ecs_institution, $ecs_uid) {
        ...
        $realm = self::getRealm(
            $url, $ecs_login, $ecs_firstname, $ecs_lastname, $ecs_email, $ecs_institution, $ecs_uid
        );
    ...
    public function getHash($mid, $url, $login, $firstname, $lastname, $email, $institution, $uid) {
        $ecs_server = new CampusConnectConfig($this->ecs_id);
        $ecs_client = new EcsClient($ecs_server['data']);
    ...
    static public function getRealm($url, $login, $firstname, $lastname, $email, $institution, $uid) {
        return sha1(self::getRealmBeforeHashing(
            $url, $login, $firstname, $lastname, $email, $institution, $uid
        ));
    }

    static public function getRealmBeforeHashing($url, $login, $firstname, $lastname, $email, $institution, $uid) {
        $output = $url
                .$login
                .$firstname
                .$lastname
