...
class CampusConnectHelperTestCase extends UnitTestCase {
    ...
    {
        $problem_string1 = "�berhaupt kein Problem";
        $problem_string2 = "��ր%6hg#'";
        $data = array('test' => $problem_string1, 'tj�' => array($problem_string2));
        ...
        //und nun wird es korrekt zur�ck codiert und sollte ein h�bsches Array
        ...
        $this->assertEqual($correctly_encoded['tj�'][0], $problem_string2);
